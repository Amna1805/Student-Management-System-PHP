...
<head>
    ...
    <title>Program Coordinator Portal</title>
</head>
...
<?php
 ...
 ?>
    ...
    <div class="feature-container">
        ...
        <a href="studentperformance.php" class="feature-box">
            <div class="feature-text">Student Performance</div>
            <img src="./images/studentperformance.jpg" alt="Student Courses">
        </a>


        <a href="inquiries.php" class="feature-box">
            <div class="feature-text">Inquiries</div>
            <img src="./images/inquiry.webp" alt="Program Coordinator Courses">
        </a>
    ...
    <div class="program-objectives">
        ...
        <div class="objectives-container">
            ...
            <div class="objective">
                ...
                <p>Fostering a culture of lifelong learning, encouraging students and faculty to continuously acquire new knowledge and skills.</p>
            </div>
            
            <div class="objective">
                <i class="fas fa-balance-scale file-icon"></i>
                <h4>Balance of Theory and Practice</h4>
                <p>Striking a balance between theoretical knowledge and practical application to ensure well-rounded education and problem-solving abilities.</p>
            </div>
            
            <div class="objective">
                <i class="fas fa-users-cog file-icon"></i>
                <h4>Community and Social Impact</h4>
                <p>Promoting engagement with the community and fostering social responsibility to make a positive impact on society through education.</p>
            </div>
    ...
    <div class="report-container">
      ...
      <div class="courses">
        ...
        <div class="course">
            <div class="cards">
                <!--Course 1-->
                <a href="programcoordinatorcoursepage.php" class="card">
