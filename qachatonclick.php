...
<body>
    ...
    <div class="chat-container">
        <a href="qachat.php"> <i class="fas fa-times close-icon"></i></a>
    ...
    <footer>
        ...
        <div class="middle-box">
            <ul>
                ...
                <li><a href="qarecomendations.php">Program</a></li>
                <li><a href="qacourses.php">Courses</a></li>
                <li><a href="qapolicies.php">Policies</a></li>
                <li><a href="qaevaluations.php">Evaluations</a></li>
                <li><a href="qaofficerprofile.php">Profile</a></li>
                <li><a href="home.php">Logout</a></li>
            </ul>
        </div>
