...
if (isset($_POST['update_qa'])) {
    ...
    if (updateQA($check)) {
        ...
        header('Location: updateqa.php?qa_id=' . $_POST['qa_id']);
    } else {
                        ...
                        <div class="detail-row">
                            ...
                            <div class="detail-item">
                                ...
                                <input type="text" id="phone_no" placeholder="Your Phone No" name="phoneNumber"
                                    value="<?php echo $qaData['qa_phone_no'] ?>">
                            </div>
                        ...
                        <div class="detail-row">
                            ...
                            <div class="detail-item">
                                ...
                                <input type="text" id="identity_no" placeholder="Your Identity No" name="idNumber"
                                    value="<?php echo $qaData['qa_identity_no'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="detail-row">
                            <div class="detail-item">
                                ...
                                <input type="text" id="empId" placeholder="Your Employee ID" name="empId"
                                    value="<?php echo $qaData['employee_id'] ?>">
                            </div>
                            <div class="detail-item">
                                <label for="password"><i class="fas fa-lock"></i> Password:</label>
                                <input type="password" id="password" placeholder="Password" name="password"
                                    value="<?php echo $qaData['qa_password'] ?>">
                            </div>
                        </div>

                    </div>
                    <button class="edit-button" name="update_qa" type="submit">Update</button>
                </form>
            </div>
            <?php
        }
