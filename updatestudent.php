      ...
      <div class="profile-details">
        ...
        <div class="detail-row">
            <div class="detail-item">
                ...
                <input type="text" id="father_name" value="Father's Name" autofocus>
              </div>
              <div class="detail-item">
                <label for="department"><i class="fas fa-building"></i> Department:</label>
                <input type="text" id="program" value="Your Department" >
              </div>
              <div class="detail-item">
        ...
        <div class="detail-row">
            <div class="detail-item">
                ...
                <input type="text" id="registration_no" value="Your Registration No" >
              </div>
          <div class="detail-item">
            <label for="program"><i class="fas fa-graduation-cap"></i> Program:</label>
            <input type="text" id="program" value="Your Program" >
          </div>
          <div class="detail-item">
            <label for="phone_no"><i class="fas fa-phone"></i> Phone No:</label>
            <input type="text" id="phone_no" value="Your Phone No" >
          </div>
        </div>
        ...
        <div class="detail-row">
            <div class="detail-item">
                ...
                <input type="text" id="identity_no" value="Your Identity No" >
              </div>
            <div class="detail-item">
                <label for="semester"><i class="fas fa-chalkboard"></i> Semester:</label>
                <input type="text" id="semester" value="Your Semester" >
              </div>
