    ...
    <form>
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="number" id="courseCredits" name="courseCredits" placeholder="Enter course credits" required>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="number" id="classesPerWeek" name="classesPerWeek" placeholder="Enter classes per week" required>
            </div>
            <div class="form-group">
                <label for="classDuration">Class Duration:</label>
                <input type="text" id="classDuration" name="classDuration" placeholder="Enter class duration" required>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <textarea id="courseContent" name="courseContent" placeholder="Enter course content" required></textarea>
            </div>
            <div class="form-group">
