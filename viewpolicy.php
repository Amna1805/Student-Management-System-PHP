    ...
    <div class="create-policy-form">
        ...
        <form>
            <div class="form-group">
                ...
                <input type="text" id="policyTitle" name="policyTitle" value="Data security"  readonly>
            </div>
            <div class="form-group">
                <label for="policyType">Policy Type:</label>
                <input id="policyType" name="policyType" value="Generic"  readonly>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea id="policyDescription" name="policyDescription" rows="8" cols="50"  readonly>We prioritize the privacy and security of data collected from our users.</textarea>
            </div>
