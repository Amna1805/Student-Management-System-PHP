...
<head>
    ...
    <title>View Program Coordinator</title>
</head>
    ...
    <div class="profile-card">
        ...
        if ($programCo == false) {
            ...
            <div class="profile-image">
                <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($programcoData['program_co_image']); ?>"
                    alt="Profile Image">
            </div>
            <div class="profile-info">
                <h2>
                    ...
                    <div class="detail-row">
                        <div class="detail-item">
                            ...
                            <input type="text" id="name" placeholder="Program Coordinator's Name" name="name" autofocus
                                value="<?php echo $programcoData['program_co_name'] ?>" disabled>
                        </div>
                        <div class="detail-item">
                            <label for="department"><i class="fas fa-building"></i> Department:</label>
                            <input type="text" id="department" placeholder="Your Department" name="department"
                                value="<?php echo $programcoData['program_co_dept'] ?>" disabled>
                        </div>
                        <div class="detail-item">
                            ...
                            <input type="text" id="phone_no" placeholder="Your Phone No" name="phoneNumber"
                                value="<?php echo $programcoData['program_co_phone_no'] ?>" disabled>
                        </div>
                    ...
                    <div class="detail-row">
                        <div class="detail-item">
                            ...
                            <input type="text" id="father_name" placeholder="Father's Name" name="fatherName"
                                value="<?php echo $programcoData['program_co_father_name'] ?>" disabled>
                        </div>
                        <div class="detail-item">
                            <label for="email"><i class="fas fa-envelope"></i> Email:</label>
                            <input type="email" id="email" placeholder="yourname@example.com" name="email"
                                value="<?php echo $programcoData['program_co_email'] ?>" disabled>
                        </div>
                        <div class="detail-item">
                            ...
                            <input type="text" id="identity_no" placeholder="Your Identity No" name="idNumber"
                                value="<?php echo $programcoData['program_co_identity_no'] ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="detail-row">
                        <div class="detail-item">
                            ...
                            <input type="text" id="empId" placeholder="Your Employee ID" name="empId"
                                value="<?php echo $programcoData['employee_id'] ?>" disabled>
                        </div>
                        <div class="detail-item">
                            <label for="password"><i class="fas fa-lock"></i> Password:</label>
                            <input type="password" id="password" placeholder="Password" name="password"
                                value="<?php echo $programcoData['program_co_password'] ?>" disabled>
                        </div>
                    </div>
                </div>
