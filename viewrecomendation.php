    ...
    <div class="create-recomendation-form">
        ...
        <form>
            <div class="form-group">
                ...
                <input type="text" id="recommendationTitle" name="recommendationTitle" value="Improving Assessment Techniques"  readonly>
            </div>
    
            <div class="form-group">
                <label for="recommendationType">Related to:</label>
                <input type="text" id="recommendationType" name="recommendationType" value="Assesment"  readonly>
            </div>
            <div class="form-group">
                <label for="lastupdated">Last updated:</label>
                <input id="lastupdated" name="lastupdated" value="September 21, 2023" readonly>
                </div>
            <div class="form-group">
                <label for="recommendationDescription">Recommendation Description:</label>
                <textarea id="recommendationDescription" name="recommendationDescription" rows="8" cols="50"  readonly>Increase taking quizes and assesmnets.</textarea>
            </div>
        </form>
    </div>
